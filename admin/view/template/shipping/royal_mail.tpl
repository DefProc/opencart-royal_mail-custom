      ...
      <table class="form">
        <tr>
          ...
          <td><div class="scrollbox">
              ...
              <div class="even">
                <?php if ($royal_mail_special_delivery) { ?>
                <input type="checkbox" name="royal_mail_special_delivery" value="1" checked="checked" />
                <?php echo $text_special_delivery; ?>
                <?php } else { ?>
                <input type="checkbox" name="royal_mail_special_delivery" value="1" />
                <?php echo $text_special_delivery; ?>
                <?php } ?>
              </div>
              <div class="odd">
		...
		<tr>
			...
			<td><input type="text" size="4" name="royal_mail_basecost" value="<?php echo $royal_mail_basecost; ?>" /></td>
		</tr>        
