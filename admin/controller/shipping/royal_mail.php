...
class ControllerShippingRoyalMail extends Controller {
	...
	public function index() {
		...
		$this->data['text_special_delivery'] = $this->language->get('text_special_delivery');
		...
		if (isset($this->request->post['royal_mail_basecost'])) {
			$this->data['royal_mail_basecost'] = $this->request->post['royal_mail_basecost'];
		} else {
			$this->data['royal_mail_basecost'] = $this->config->get('royal_mail_basecost');
		}
		...
		if (isset($this->request->post['royal_mail_special_delivery'])) {
			$this->data['royal_mail_special_delivery'] = $this->request->post['royal_mail_special_delivery'];
		} else {
			$this->data['royal_mail_special_delivery'] = $this->config->get('royal_mail_special_delivery');
		}
